...
type InventoryServiceClient interface {
	...
	ListInventory(ctx context.Context, in *ListInventoryRequest, opts ...grpc.CallOption) (*ListProductsResponse, error)
...
func (c *inventoryServiceClient) ListInventory(ctx context.Context, in *ListInventoryRequest, opts ...grpc.CallOption) (*ListProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsResponse)
...
type InventoryServiceServer interface {
	...
	ListInventory(context.Context, *ListInventoryRequest) (*ListProductsResponse, error)
...
func (UnimplementedInventoryServiceServer) ListInventory(context.Context, *ListInventoryRequest) (*ListProductsResponse, error) {
